...
@section( 'pageTitle' )
Contract Of Service Payroll Report
@endsection
...
<h1>
    Contract Of Service <small>Find Reports</small>
</h1>
@endsection
...
<ol class="breadcrumb">
    <li>
        <a href="#"><i class="fa fa-money"></i>Contract of Service</a>
    </li>
    <li>
