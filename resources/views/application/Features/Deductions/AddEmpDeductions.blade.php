...
<ol class="breadcrumb">
    ...
    <li>
        <a href="#">Add Employee Deductions</a>
    </li>
</ol>
@endsection
...
@section( 'deductions-submenu1-active' )
active
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary no-border-radius">
            ...
            <div class="box-body">
                ...
                <form id="deductionsForm" method="post" name="deductionsForm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control no-border-radius" id="employeeNumber" name="employeeNumber" style="width: 100%;">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control input-group" id="gsisPolicy" maxlength="16" name="gsisPolicy" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisEmergency" maxlength="16" name="gsisEmergency" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisUmidCa" maxlength="16" name="gsisUmidCa" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisUoliLoan" maxlength="16" name="gsisUoliLoan" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisUoliPolicy" maxlength="16" name="gsisUoliPolicy" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisEducation" maxlength="16" name="gsisEducation" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisConsolidated" maxlength="16" name="gsisConsolidated" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisGfal" maxlength="16" name="gsisGfal" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <small class="text-muted">GSIS MPL</small>
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisMpl" maxlength="16" name="gsisMpl" type="text">
                                </div>
                                <small class="text-red" id="gsisMplErrorText"></small>
                            </div>
                            <div class="col-md-3">
                                <small class="text-muted">GSIS Computer Loan</small>
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisComputerLoan" maxlength="16" name="gsisComputerLoan" type="text">
                                </div>
                                <small class="text-red" id="gsisComputerLoanErrorText"></small>
                            </div>
                            <div class="col-md-3">
                                <small class="text-muted">Landbank</small>
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="landBank" maxlength="16" name="landBank" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="plmPcci" maxlength="16" name="plmPcci" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="philamLife" maxlength="16" name="philamLife" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="studyGrant" maxlength="16" name="studyGrant" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="pagIbigMpl" maxlength="16" name="pagIbigMpl" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="pagIbigEcl" maxlength="16" name="pagIbigEcl" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="pagIbigPremium" maxlength="16" name="pagIbigPremium" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="pagIbigMp2" maxlength="16" name="pagIbigMp2" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="nhmfc" maxlength="16" name="nhmfc" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="maxicare" maxlength="16" name="maxicare" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="otherBills" maxlength="16" name="otherBills" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="lvtPay" maxlength="16" name="lvtPay" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="atDays" maxlength="16" name="atDays" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="atHours" maxlength="16" name="atHours" type="text">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="atMinutes" maxlength="16" name="atMinutes" type="text">
                                </div>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="manualWhTax" maxlength="16" name="manualWhTax" type="text">
                                </div>
