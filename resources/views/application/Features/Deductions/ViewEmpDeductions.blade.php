                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisMpl" maxlength="16" name="gsisMpl" type="text" value="{{ $employeeDeductions[0]->gsisMpl }}">
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2"><span class="fa fa-address-card-o"></span></span>
                                    <input class="form-control input-group" id="gsisComputerLoan" maxlength="16" name="gsisComputerLoan" type="text" value="{{ $employeeDeductions[0]->gsisComputerLoan }}">
                                </div>
