    ...
    $( document ).ready( function() {
        ...
        empIncludedTable.DataTable({
            ...
            drawCallback: function ( settings ) {
                ...
                $( '.btnRemove' ).on( 'click', function () {
                    ...
                    var index = row.index();
                    empIncludedTable.DataTable().row( index ).remove().draw( false );
                } );
            }
        });;
        ...
        empOtherCollegeTable.DataTable({
            ...
            drawCallback: function ( settings ) {
                ...
                // set the click event of the button on the new row (deletion of row)
                $( '.btnOtherRemove' ).on( 'click', function () {
                    var row = $( 'tr[data-id="' + $( this ).data( 'id' ) + '"]' );
                    var index = row.index();
                    empOtherCollegeTable.DataTable().row( index ).remove().draw( false );
                } );
            }
        });;
            ...
            $.ajax({
                ...
                try {
                    ...
                    if( jsonData.recordId !== undefined ) {
                        window.location = '/parttime/report/view/id/' + jsonData.recordId;
