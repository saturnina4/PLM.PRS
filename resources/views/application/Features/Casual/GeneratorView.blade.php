...
<h1>
    Casual Payroll <small>Generate Report</small>
</h1>
@endsection
...
@section( 'cp-gen-active' )
active
@endsection

@section( 'cp-gen-regular-active' )
active
@endsection
                            ...
                            <table class="table table-bordered table-striped table-hover" id="empTable">
                                <thead class="thead-inverse">
                                    <tr>
                                        ...
                                        <th class="table-custom" style="text-align: center;">NO. OF DAYS</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    @foreach( $empList as $item )
                                        <tr>
                                            <td>
                                                <input name="empId[]" type="hidden" value="{{ $item->employeeNumber }}">
                                                {{ $item->fullName . ' - ' . $item->deptname }}
                                            </td>
                                            <td>
                                                <input class="form-control" data-id="" name="noOfDays[]" required style="text-align: right; width: 100%" type="text">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
            ...
            $.ajax({
                ...
                try {
                    ...
                    if( jsonData.recordId !== undefined ) {
                        window.location = '{{ config('app.root') }}/casual/report/view/id/' + jsonData.recordId;
