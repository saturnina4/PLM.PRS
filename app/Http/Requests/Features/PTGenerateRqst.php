...
class PTGenerateRqst extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'noOfHrs.*'          => 'bail|nullable|numeric|min:1|max:200',//formerly required
            ...
            'incNoOfHrs.*'       => 'bail|required|numeric|min:1|max:200',
            ...
            'otherNoOfHrs.*'     => 'bail|required|numeric|min:1|max:200',
