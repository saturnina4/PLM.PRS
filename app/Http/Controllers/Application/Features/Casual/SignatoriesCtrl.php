...
use MiSAKACHi\VERACiTY\Http\Requests\Features\CPEditSignatoriesRqst;
...
final class SignatoriesCtrl extends Controller {
    ...
    public function getAction( Request $request ) {
        ...
        return view( 'Application.Features.Casual.Signatories' )
            ->with( 'empDetails', $empDetails )
            ->with( 'signatories', $signatories );
    }

    public function postAction( CPEditSignatoriesRqst $request ) {
        try {
