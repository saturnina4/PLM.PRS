...
final class ViewReportCtrl extends Controller {
    ...
    public function __construct() {
        ...
        $this->reportDataModel      = new CPReportDataMdl();
        $this->reportParamsModel    = new CPReportParamsMdl();
        $this->reportSummaryModel   = new CPReportSummaryMdl();
    }
    ...
    public function getAction( Request $request, $recordId ) {
        if( ctype_xdigit( $recordId ) && mb_strlen( $recordId ) == 32 ) {
            ...
            if( count( $reportData ) > 0 ) {
                ...
                return view( 'Application.Features.Casual.ViewReportView' )
