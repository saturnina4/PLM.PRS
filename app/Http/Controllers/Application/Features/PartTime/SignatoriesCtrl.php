...
use MiSAKACHi\VERACiTY\Http\Requests\Features\PTEditSignatoriesRqst;
...
final class SignatoriesCtrl extends Controller {
    ...
    public function getAction( Request $request ) {
        ...
        return view( 'Application.Features.PartTime.Signatories' )
            ->with( 'empDetails', $empDetails )
            ->with( 'signatories', $signatories );
    }

    public function postAction( PTEditSignatoriesRqst $request ) {
        try {
