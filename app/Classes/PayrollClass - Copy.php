    ...
    public function individualCasual( array $input, string $yearMonth, $cutOffPeriod, $mode ) {
        try {
            ...
            if ( $cutOffPeriod == 1 ) {
                ...
                $atDeductionData    = $this->computationClass->atDeductions( 1, ( float ) $employee->salaryValue, $empPera, $atDays, $atHours, $atMinutes, 22, 0.00 );
                $atSalaryDeductions = $atDeductionData['atDeductions'];
                ...
                // if ( $empStudyGrant > 0 && $empNetSalary - $empStudyGrant >= 2500 ) {
                ...
                // if ( $empPagIbigMp2 > 0 && $empNetSalary - $empPagIbigMp2 >= 2500 ) {
                    // $empNetSalary -= $empPagIbigMp2;
                    // $deductions['empPagIbigMp2'] = $empPagIbigMp2;
                // }
                // if ( $empNhmfc > 0 && $empNetSalary - $empNhmfc >= 2500 ) {
                ...
                $totalNoOfDays += $firstQuincenaData[0]->empNoOfDays ?? 0;
                ...
                if ( ( $firstQuincenaData[0]->gsis_lr == null || $firstQuincenaData[0]->gsis_lr == 0 ) && $empNetSalary - $empGsisLr >= 2500 ) {
                    $empNetSalary -= $empGsisLr;
                    $deductions['empGsisLr'] = $empGsisLr;
                }
                if ( ( $firstQuincenaData[0]->ded_philHealth == null || $firstQuincenaData[0]->ded_philHealth == 0 ) && $empNetSalary - $empPhilHealth >= 2500 ) {
                    $empNetSalary -= $empPhilHealth;
                    $deductions['empPhilHealth'] = $empPhilHealth;
                }
                if ( $empNetSalary - $atSalaryDeductions >= 2500 ) {
                ...
                if ( ( $firstQuincenaData[0]->pi_premium == null || $firstQuincenaData[0]->pi_premium == 0 ) && $empNetSalary - $empPagIbig >= 2500 ) {
                    $empNetSalary -= $empPagIbig;
                    $deductions['empPagIbig'] = $empPagIbig;
                }
                if ( ( $firstQuincenaData[0]->ded_plmPcci == null || $firstQuincenaData[0]->ded_plmPcci == 0 ) && $empPlmPcci > 0 && $empNetSalary - $empPlmPcci >= 2500 ) {
                    $empNetSalary -= $empPlmPcci;
                    $deductions['empPlmPcci'] = $empPlmPcci;
                }
                // if ( $empStudyGrant > 0 && $empNetSalary - $empStudyGrant >= 2500 ) {
                    ...
                    // $deductions['empStudyGrant'] = $empStudyGrant;
                // }
                if ( ( $firstQuincenaData[0]->gsis_consolidated == null || $firstQuincenaData[0]->gsis_consolidated == 0 ) && $empGsisConsolidated > 0 && $empNetSalary - $empGsisConsolidated >= 2500 ) {
                    $empNetSalary -= $empGsisConsolidated;
                    $deductions['empGsisConsolidated'] = $empGsisConsolidated;
                }
                if ( ( $firstQuincenaData[0]->gsis_education == null || $firstQuincenaData[0]->gsis_education == 0 ) && $empGsisEducation > 0 && $empNetSalary - $empGsisEducation >= 2500 ) {
                    $empNetSalary -= $empGsisEducation;
                    $deductions['empGsisEducation'] = $empGsisEducation;
                }
                if ( ( $firstQuincenaData[0]->gsis_emergency == null || $firstQuincenaData[0]->gsis_emergency == 0 ) && $empGsisEmergency > 0 && $empNetSalary - $empGsisEmergency >= 2500 ) {
                    $empNetSalary -= $empGsisEmergency;
                    $deductions['empGsisEmergency'] = $empGsisEmergency;
                }
                if ( ( $firstQuincenaData[0]->gsis_policy == null || $firstQuincenaData[0]->gsis_policy == 0 ) && $empGsisPolicy > 0 && $empNetSalary - $empGsisPolicy >= 2500 ) {
                    $empNetSalary -= $empGsisPolicy;
                    $deductions['empGsisPolicy'] = $empGsisPolicy;
                }
                // if ( $empGsisUmidCa > 0 && $empNetSalary - $empGsisUmidCa >= 2500 ) {
                ...
                // if ( $empGsisGfal > 0 && $empNetSalary - $empGsisGfal >= 2500 ) {
                    ...
                    // $deductions['empGsisGfal'] = $empGsisGfal;
                // }
                if ( ( $firstQuincenaData[0]->pi_mpl == null || $firstQuincenaData[0]->pi_mpl == 0 ) && $empPagIbigMpl > 0 && $empNetSalary - $empPagIbigMpl >= 2500 ) {
                    $empNetSalary -= $empPagIbigMpl;
                    $deductions['empPagIbigMpl'] = $empPagIbigMpl;
                }
                if ( ( $firstQuincenaData[0]->pi_ecl == null || $firstQuincenaData[0]->pi_ecl == 0 ) && $empPagIbigEcl > 0 && $empNetSalary - $empPagIbigEcl >= 2500 ) {
                    $empNetSalary -= $empPagIbigEcl;
                    $deductions['empPagIbigEcl'] = $empPagIbigEcl;
                }
                // if ( $empPagIbigMp2 > 0 && $empNetSalary - $empPagIbigMp2 >= 2500 ) {
                ...
                // if ( $empNhmfc > 0 && $empNetSalary - $empNhmfc >= 2500 ) {
                    ...
                    // $deductions['empNhmfc'] = $empNhmfc;
                // }
                if ( ( $firstQuincenaData[0]->ded_maxicare == null || $firstQuincenaData[0]->ded_maxicare == 0 ) && $empMaxicare > 0 && $empNetSalary - $empMaxicare >= 2500 ) {
                    $empNetSalary -= $empMaxicare;
                    $deductions['empMaxicare'] = $empMaxicare;
                }
                if ( ( $firstQuincenaData[0]->ded_otherBills == null || $firstQuincenaData[0]->ded_otherBills == 0 ) && $empOtherBills > 0 && $empNetSalary - $empOtherBills >= 2500 ) {
                    $empNetSalary -= $empOtherBills;
                    $deductions['empOtherBills'] = $empOtherBills;
                }
